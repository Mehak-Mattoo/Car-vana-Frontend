...
export default function AddNotesBtn(props) {
  ...
  return (
    <div className="w-full h-full">
      <div style={{ top: "80%" }} className="fixed right-11">
        <SpeedDial>
          ...
          <SpeedDialContent className="snap-y">
            <SpeedDialAction>
              <Tooltip
              // className="bg-black text-white dark:bg-white dark:text-black mr-10"
              // content="Add Note"
              // placement="right"
              >
                <i
                  ...
                  //   style={{ fontSize: "1.2rem", color: "#1E3050" }}
                ></i>
              </Tooltip>
            </SpeedDialAction>
          </SpeedDialContent>
      ...
      <CreateNote title="Add A New Car" handleOpen={handleOpen} open={open} />
    </div>
  );
}
